...
<div class="modal fade" id="tambahDataKandidat" tabindex="-1" role="dialog" aria-labelledby="tambahDataKandidatTitle" aria-hidden="true">
        <div class="modal-dialog" role="document" id="center">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="tambahDataKandidatTitle">Tambah Data Kandidat</h5>
...
<!-- modal edit-->
<div class="modal fade" id="editDataKandidat" tabindex="-1" role="dialog" aria-labelledby="editDataKandidatTitle" aria-hidden="true">
        <div class="modal-dialog" role="document" id="center">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDataKandidatTitle">Edit Data Kandidat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
